...
public:
	...
	void on_fire_event(IGameEvent* event)
	{
		if (!strcmp(event->GetName(), "player_hurt")) {
			...
			if (Interfaces::Engine->GetPlayerForUserID(attacker) == Interfaces::Engine->GetLocalPlayer() && Menu::Window.VisualsTab.OtherHitmarkerSound.GetState())
			{
...
private:
	...
	const char*             _soundFileName = "csgo\\sound\\úhavepathhirsound.wav";
	float                   _flHurtTime;
};
